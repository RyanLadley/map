    ...
    concat: {
        ...
        dist: {
            src: ['./lib/jquery/jquery-2.2.4.js', './lib/angular/angular.min.js', './lib/angular/modules/*.min.js',
                './lib/charts/d3.js', './lib/charts/topojson-client.js', './lib/charts/datamaps.usa.js', './lib/google/lodash.js',
                './lib/google/angular-simple-logger.js', './lib/google/google-maps.js',
